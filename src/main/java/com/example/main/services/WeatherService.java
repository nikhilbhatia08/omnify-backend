...
public class WeatherService extends MappingJackson2HttpMessageConverter   {
    ...
    String api_key = "487fc1eb9848ebbbdb7a6a07f988496d";
    ...
    public List<Example> getWeatherForFive(String city) throws ParseException {
        ...
        String websiteResponse = "http://api.openweathermap.org/data/2.5/forecast?q=" + city + "&mode=json&appid="+api_key+"&units=metric";
    ...
    public List<Example> getWeather(String city) {
        ...
        String websiteResponse = "http://api.openweathermap.org/data/2.5/weather?q="+ city + "&mode=json&appid=+"+api_key+"+&units=metric";
